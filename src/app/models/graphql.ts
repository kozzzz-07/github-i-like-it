...
export type StarredMyRepositoriesQuery = { __typename?: 'Query' } & {
  viewer: { __typename?: 'User' } & Pick<User, 'id' | 'login'> & {
      starredRepositories: {
        __typename?: 'StarredRepositoryConnection';
          ...
          edges?: Maybe<
            Array<
              Maybe<
                { __typename?: 'StarredRepositoryEdge' } & Pick<
                  StarredRepositoryEdge,
                  'cursor' | 'starredAt'
                > & {
                    node: { __typename?: 'Repository' } & Pick<
                      Repository,
                      | 'id'
                      | 'name'
                      | 'nameWithOwner'
...
export class StarredMyRepositoriesGQL extends Apollo.Query<
  StarredMyRepositoriesQuery,
  StarredMyRepositoriesQueryVariables
> {
