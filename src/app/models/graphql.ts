...
export type StarredMyRepositoriesQuery = (
  { __typename?: 'Query' }
  & { viewer: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'login'>
    & { starredRepositories: (
      ...
      & { pageInfo: (
        ...
        { __typename?: 'StarredRepositoryEdge' }
        & Pick<StarredRepositoryEdge, 'cursor' | 'starredAt'>
        & { node: (
          { __typename?: 'Repository' }
          & Pick<Repository, 'id' | 'name' | 'nameWithOwner' | 'createdAt' | 'updatedAt' | 'pushedAt' | 'stargazerCount' | 'openGraphImageUrl' | 'forkCount' | 'url' | 'description'>
          & { issues: (
            { __typename?: 'IssueConnection' }
...
export const StarredMyRepositoriesDocument = gql`
  ...
  viewer {
    id
    login
    starredRepositories(first: $first, after: $after, last: $last, before: $before) {
      totalCount
      pageInfo {
        endCursor
        hasNextPage
  ...
  export class StarredMyRepositoriesGQL extends Apollo.Query<StarredMyRepositoriesQuery, StarredMyRepositoriesQueryVariables> {
    document = StarredMyRepositoriesDocument;
